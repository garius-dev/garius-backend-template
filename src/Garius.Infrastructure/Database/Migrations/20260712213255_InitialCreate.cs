    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_pii_access_logs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cpf = table.Column<byte[]>(type: "bytea", nullable: false),
                    CpfIndex = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_pii_access_logs_ActorUserId_CreatedAt",
                table: "pii_access_logs",
                columns: new[] { "ActorUserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_pii_access_logs_Enabled",
                table: "pii_access_logs",
                column: "Enabled");

            migrationBuilder.CreateIndex(
                name: "IX_pii_access_logs_EntityType_EntityId",
                table: "pii_access_logs",
                columns: new[] { "EntityType", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_pii_access_logs_TenantId",
                table: "pii_access_logs",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_claims_UserId_TenantId",
                table: "user_claims",
